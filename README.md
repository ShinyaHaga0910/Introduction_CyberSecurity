...
- [教材 v1.5.0（現在の推奨版）](./2026/materials/ubuntu_os_foundations/v1.5.0/README.md)
...
教材には、章別Markdown、言語別directory、用語管理、図、図生成program、HTML/PDF生成program、設計・検証資料、配布用HTML/PDFを含みます。v1.5.0では、第2章の歴史写真をDEC PDP-7の保存機へ変更し、第4章の階層図とホームディレクトリ、アクセス権の説明を改訂しました。現行図21点と旧版PNG 21点も保持しています。英語を将来の翻訳原本とし、日本語、ウズベク語、ロシア語を同じ章IDで管理します。
