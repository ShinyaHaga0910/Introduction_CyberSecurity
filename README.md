...
`v1.2.1`が現在の推奨版です。M0～M7の8課題を実装し、v1.2.0のMission resetエラーを修正しています。ローカル自動試験済みですが、AWS Academy Learner Lab実機での全Mission受入試験は未完了です。
...
4. `2026/v1.2.1/install.sh`をダウンロードします。
5. checksumを確認します。
