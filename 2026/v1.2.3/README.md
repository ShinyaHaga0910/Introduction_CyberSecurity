# Introduction CyberSecurity Lab 2026 v1.2.3
...
```text
https://raw.githubusercontent.com/ShinyaHaga0910/Introduction_CyberSecurity/main/2026/v1.2.3/install.sh
```
...
- M0は`PASS`と`FAIL`だけを表示する。
- 最後に「6問中何問クリアしたか」を表示する。
