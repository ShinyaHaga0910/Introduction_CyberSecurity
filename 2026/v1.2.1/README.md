# Introduction CyberSecurity Lab 2026 v1.2.1
...
```text
https://raw.githubusercontent.com/ShinyaHaga0910/Introduction_CyberSecurity/main/2026/v1.2.1/install.sh
```
...
`jdu-fixture reset M0`を含む全Missionのresetで、`set -u`により`mission_id: unbound variable`となる問題を修正しました。変数を代入してから、その値を使ってMission directoryを組み立てます。回帰試験を`tests/run-tests.sh`へ追加しました。
