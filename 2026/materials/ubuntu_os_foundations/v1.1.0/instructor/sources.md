...
| Ubuntu user | Ubuntu Server User management | 2026-09-18 | 第6章 |
| APT | Ubuntu Server Install and manage packages | 2026-09-18 | 第9章 |
...
- Web取得できなかったBash、systemd、Ubuntu Noble man pageの本文。制作内容は実機manualで再確認する。
