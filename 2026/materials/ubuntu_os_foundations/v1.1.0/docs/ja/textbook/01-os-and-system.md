...
![パソコンとサーバーに共通する構成](../../../assets/figures/fig01-os-resource-map.png)
...
![ユーザー空間とカーネル空間](../../../assets/figures/fig02-user-kernel-boundary.png)
...
![Linuxシステムの起動順序](../../../assets/figures/fig02b-linux-boot-sequence.png)
...
![ホストとユーザーの識別](../../../assets/figures/fig02c-host-user-identity.png)
