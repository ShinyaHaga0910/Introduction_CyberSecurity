...
| fig03 | 2 | 系統分離付き歴史・関係図 | D2 | Unix系・Unix互換系とWindows NT系の関係 | 継承と影響を線種で分け、Windowsを独立した枠へ置く。BashをOSとして描かない |
...
| fig06 | 4 | ファイルシステムのツリー図 | D2 | absolute/relative pathの起点 | directoryを単なる物理箱に固定しない |
