...
英語版を将来の翻訳原本とし、同じ章ID・図IDを日本語、ウズベク語、ロシア語で維持します。現時点で完成している本文は日本語のみです。コマンド、パス、ユーザー名、グループ名、ユニット名、チェックIDは全言語で共通とし、訳語は[`localization/terminology.csv`](./localization/terminology.csv)で管理します。
