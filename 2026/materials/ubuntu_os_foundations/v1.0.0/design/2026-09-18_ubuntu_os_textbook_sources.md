...
確認日: 2026-09-18。本文取得ができた資料と、取得できなかった候補を区別する。
...
| [GNU Bash manual](https://www.gnu.org/software/bash/manual/bash.html) | 取得timeout | Ubuntu上の`man bash`と公式manualの取得可能な節で、引用、展開、redirect、終了statusを確認 |
...
| 2 | H01～H05、追加GNU一次資料 | 継承・影響・独立実装の違い、年表の各矢印と年号の出典 |
