...
| SSH遠隔操作と転送 | Ubuntu [OpenSSH server](https://ubuntu.com/server/docs/how-to/security/openssh-server/)、OpenBSD [ssh(1)](https://man.openbsd.org/ssh)、[ssh_config(5)](https://man.openbsd.org/ssh_config)、[scp(1)](https://man.openbsd.org/scp)、GNU [sha256sum(1)](https://man7.org/linux/man-pages/man1/sha256sum.1.html) | 2026-09-24 | 第12章。鍵、別名、遠隔実行、SCP、内容比較 |
| SSH over SSM | AWS Systems Manager official guide | 2026-09-18 | 演習環境固有の運用資料。教科書第12章には記載しない |
