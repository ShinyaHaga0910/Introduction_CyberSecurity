...
![Unix、GNU、Linux、Ubuntu、macOS、Windowsの関係](../../../assets/figures/fig03-os-history-map.png)

**図2-1　ソースコードの継承、設計上の影響、システムへの統合を区別した歴史・構成図。** WindowsはUnixの直系として描かず、macOSはLinuxの派生として描かない。
...
![Linux kernelからUbuntu systemになる構成](../../../assets/figures/fig04-linux-distribution-stack.png)
...
1. LinuxとUbuntuの違いを、「カーネル」と「ディストリビューション」という用語を用いて説明せよ。
2. macOSをLinuxディストリビューションと呼べない理由を説明せよ。
3. Windowsにもプロセスやアクセス権が存在することは、WindowsがUnixから直接派生した証拠になるか。理由とともに答えよ。
