# Introduction CyberSecurity Lab 2026 v1.4.0
...
```bash
curl -fsSLO https://raw.githubusercontent.com/ShinyaHaga0910/Introduction_CyberSecurity/main/2026/v1.4.0/install.sh
...
教員の進捗サーバーへ最新結果を送る場合は、`--submit`を付けます。採点結果は変わりません。送信失敗も別に表示されます。
...
```bash
curl -fsSL \
  https://raw.githubusercontent.com/ShinyaHaga0910/Introduction_CyberSecurity/main/2026/v1.4.0/teacher/install-teacher.sh \
...
- `jdu-check M1 --submit`でlocal判定後に結果を送れるようにしました。
