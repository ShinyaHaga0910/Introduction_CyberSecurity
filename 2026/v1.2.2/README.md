# Introduction CyberSecurity Lab 2026 v1.2.2
...
```text
https://raw.githubusercontent.com/ShinyaHaga0910/Introduction_CyberSecurity/main/2026/v1.2.2/install.sh
```
...
- M0の環境確認7項目と学生課題6問を画面上で分離した。
- 学生課題を`M0-OBS-01`～`M0-OBS-06`として個別判定する。
- `cloud-init`未完了は学生の解答エラーに数えず、環境警告として実際の状態を表示する。
