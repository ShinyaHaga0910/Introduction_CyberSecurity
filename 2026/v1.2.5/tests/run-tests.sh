...
assert parameters["LabVersion"]["AllowedValues"] == ["v1.2.5"]
...
assert "ERROR lines are correct, but original line numbers are missing" in checker
assert "grep -n 'ERROR'" in checker
