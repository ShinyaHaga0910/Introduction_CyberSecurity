# Introduction CyberSecurity Lab 2026 v1.2.5
...
```text
https://raw.githubusercontent.com/ShinyaHaga0910/Introduction_CyberSecurity/main/2026/v1.2.5/install.sh
```
...
- M1の`errors.txt`について、入力file、行番号の意味、出力形式、標準出力から保存する要件を明記する。
- ERROR行は正しいが行番号だけがない場合、LabCheckが不足内容を具体的に表示する。
