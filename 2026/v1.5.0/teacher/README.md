...
The installer prints the one-line student installation command. The current progress endpoint and registration key are fixed in the v1.5.0 student installer, so students do not enter either value.
