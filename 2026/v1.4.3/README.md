# Introduction CyberSecurity Lab 2026 v1.4.3
...
```bash
curl -fsSLO https://raw.githubusercontent.com/ShinyaHaga0910/Introduction_CyberSecurity/main/2026/v1.4.3/install.sh
...
M6はCloudShellとUbuntuの両方で`jdu-check M6`を実行します。DashboardではUbuntu 2件、CloudShell 4件、合計6件を分けて表示します。両方が全件PASSになったときだけM6完了です。CloudShellのM6だけをやり直す場合も`jdu-reset M6`を使います。
...
```bash
curl -fsSL \
  https://raw.githubusercontent.com/ShinyaHaga0910/Introduction_CyberSecurity/main/2026/v1.4.3/teacher/install-teacher.sh \
