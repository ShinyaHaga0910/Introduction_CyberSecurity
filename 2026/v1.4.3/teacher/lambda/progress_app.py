...
MISSION_RE = re.compile(r"^(?:M[0-7]|M6U|M6C)$")
...
def dashboard(event):
    ...
    for server in scan_servers():
        ...
        m6_ubuntu = mission_score(missions, "M6U")
        m6_cloud = mission_score(missions, "M6C")
        if m6_ubuntu and m6_cloud and m6_ubuntu["complete"] and m6_cloud["complete"]:
            completed += 1
