# Introduction CyberSecurity Lab 2026 v1.2.10
...
| `scripts/jdu-probe` | M6の安全な負試験を実行・記録するscript |
...
```bash
curl -fsSLO https://raw.githubusercontent.com/ShinyaHaga0910/Introduction_CyberSecurity/main/2026/v1.2.10/install.sh
...
- M6の負試験は、対応する正試験が成立した後だけ合格になる。
- Learner Lab実機でM0～M7のreference solution受入試験が必要である。

## Planned URL

```text
https://raw.githubusercontent.com/ShinyaHaga0910/Introduction_CyberSecurity/main/2026/v1.2.10/install.sh
```
